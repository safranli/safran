$(document).ready(function(){
    $("#2027Extend").click(function() {
        if ($("#2027Container").is(":hidden")) {
            $('#2027Container').show();
            $('#2027Extend i').attr("class", "fas fa-caret-right");
            $('#2027Extend i').attr("class", "fas fa-caret-down");
        }
        else {
            $('#2027Container').hide();
            $('#2027Extend i').attr("class", "fas fa-caret-down");
    ...
    $("#2026Extend").click(function() {
        if ($("#2026Container").is(":hidden")) {
            $('#2026Container').show();
            $('#2026Extend i').attr("class", "fas fa-caret-right");
            $('#2026Extend i').attr("class", "fas fa-caret-down");
        }
        else {
            $('#2026Container').hide();
            $('#2026Extend i').attr("class", "fas fa-caret-down");
    ...
    $("#2025Extend").click(function() {
        if ($("#2025Container").is(":hidden")) {
            $('#2025Container').show();
            $('#2025Extend i').attr("class", "fas fa-caret-right");
            $('#2025Extend i').attr("class", "fas fa-caret-down");
        }
        else {
            $('#2025Container').hide();
            $('#2025Extend i').attr("class", "fas fa-caret-down");
    ...
    $("#2024Extend").click(function() {
        if ($("#2024Container").is(":hidden")) {
            $('#2024Container').show();
            $('#2024Extend i').attr("class", "fas fa-caret-right");
            $('#2024Extend i').attr("class", "fas fa-caret-down");
        }
        else {
            $('#2024Container').hide();
            $('#2024Extend i').attr("class", "fas fa-caret-down");
